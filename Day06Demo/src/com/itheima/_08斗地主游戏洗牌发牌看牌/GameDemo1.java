...
public class GameDemo1 {
    ...
    public static final Map<Card1, Integer> ALL_CARDS_SIZE = new HashMap<>();
    // 真正存储54张牌对象的List集合，用于做牌，洗牌，发牌！
    public static final List<Card1> ALL_CARDS = new ArrayList<>();
    /** 2.做牌：静态代码块初始化54张牌对象  */
    static {
        ...
        for (String number : numbers) {
            ...
            for (String color : colors) {
                // 创建一张牌对象封装点数和花色
                Card1 card = new Card1(number , color);
                ALL_CARDS.add(card);
    ...
    public static void main(String[] args) {
        ...
        /**
         d.定义3个玩家。
         */
        List<Card1> lingHuChong = new ArrayList<>();
        List<Card1> jiuMoZhi = new ArrayList<>();
        List<Card1> dongfangbubai = new ArrayList<>();
        ...
        List<Card1> lastThreeCards = ALL_CARDS.subList(ALL_CARDS.size() -3 , ALL_CARDS.size());
    ...
    /**
     对牌的List集合进行排序（降序排序）
     */
    private static void sortCards(List<Card1> cards) {
        // cards = [ 3♦ , 👲,  10♣ , 9♦ , 8♦ , J♠ , ...
